...
function App() {
	...
	// With a function using navigate('redirect_to_route') choose a Component 
	// within the <Router> tag
	...
	return (
	    <div className="App">
			...
			<h1>App Component</h1>
			<h2>is displayed automatically when the App loads !</h2>

			<button onClick={ my_function } > Go & display NavBar </button>
